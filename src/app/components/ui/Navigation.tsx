        ...
        <div className="container mx-auto px-4 xl:px-6 2xl:px-10">
          <ul className="flex justify-between items-center flex-wrap py-2 text-sm xl:text-base font-medium">
            ...
            <li className="relative group px-1 lg:px-2">
              <Link 
                href="/equipements" 
                className={`${isActive('/equipements') ? 'gold-text font-bold' : 'hover:gold-text transition-colors'}`}
              >
                Équipements d'écuries
              </Link>
              <ul className="absolute top-full left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out transform scale-95 group-hover:scale-100 white-bg shadow-md z-50 text-left text-sm min-w-[200px] rounded-md overflow-hidden">
                <li><Link href="/equipements/barns" className="block px-4 py-2 hover:bg-gray-100 hover:gold-text transition-colors">Barns</Link></li>
                <li><Link href="/equipements/boxes" className="block px-4 py-2 hover:bg-gray-100 hover:gold-text transition-colors">Boxes</Link></li>
                <li><Link href="/equipements/pare-botte" className="block px-4 py-2 hover:bg-gray-100 hover:gold-text transition-colors">Pare Botte</Link></li>
                <li><Link href="/equipements/herse" className="block px-4 py-2 hover:bg-gray-100 hover:gold-text transition-colors">Herse de carrière</Link></li>
              </ul>
            </li>
            ...
            <li className="border-b border-gray-100">
              <div className="flex justify-between items-center px-4 py-3">
                <Link 
                  ...
                  className={isActive('/equipements') ? 'gold-text font-bold' : ''}
                >
                  Équipements d'écuries
                </Link>
                <button 
