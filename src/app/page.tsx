    ...
    <div className="overflow-x-hidden flex flex-col items-center">
      <div className="w-full max-w-[2400px] xl:px-10 xl:mt-10 mt-4 px-4">
        <div className="relative w-full">
          ...
          {/* Bloc supperposé */}
          <div className="absolute sm:top-8 sm:left-8 bottom-0 h-fit bg-black/25 backdrop-blur-md rounded-xl py-2 sm:py-4 px-4 md:px-8 shadow-md xl:w-1/4 flex flex-col justify-evenly gap-1 sm:gap-3 text-center w-[100%] sm:w-[40%] md:w-1/3 width-3xl">
            <h2 className="text-s lg:text-xl font-bold text-white">Au service de vos besoins</h2>
            <p className="text-white text-xs lg:text-lg sm:pt-1">
              Des bâtiments pour des solutions énergétiques qui changent le monde et vous facilitent la vie.
            </p>
            <button className="text-white p-1.5 lg:p-3 gold-bg rounded-xl text-xs lg:text-lg hover:shadow-lg hover:brightness-110 transition-all duration-300" type='button'><Link href="/etude-faisabilite">Demandez une étude</Link></button>
          </div>
        </div>
        
        <section className="flex flex-col md:flex-row my-4 lg:my-8 lg:gap-4">
          <div className="flex flex-col text-center md:w-1/2 items-center justify-evenly p-4 lg:p-8">
              <h2 className="md:text-2xl text-base font-bold text-center 2xl:w-[75%] py-3 md:py-5 2xl:py-8 border-t-2 border-b-2 border-[color:var(--gold)]">
                Une famille de cavaliers qui s'investit pour les cavaliers
              </h2>
              <p className="xl:text-xl md:text-sm lg:text-base 2xl:w-3/4 py-4">
              ...
              <button className="text-white p-3 gold-bg rounded-xl w-[80%] md:w-[60%] text-base xl:text-lg hover:shadow-lg hover:brightness-110 transition-all duration-300" type='button'><Link href="/etude-faisabilite">En savoir plus</Link></button>
          </div>
      ...
      <div className="h-[10rem] sm:h-[16rem] lg:h-[28rem] w-full bg-[url('/abri-de-prairie.webp')] sm:bg-[url('/view4.webp')] bg-cover bg-left sm:bg-fixed mb-4 lg:mb-8">
      </div>
      ...
      <div className="w-full max-w-[2400px] px-4 lg:px-10">
        <section className="flex flex-col items-center gap-8 border-2 border-[color:var(--gold)] rounded-xl sm:py-8 py-6 px-8 sm:px-12">
          <button className="text-white p-3 gold-bg rounded-xl w-[80%] md:w-[60%] xl:w-[40%] text-lg hover:shadow-lg hover:brightness-110 transition-all duration-300" type='button'><Link href="/a-propos">Qui sommes-nous ?</Link></button>
          <p className="text-base lg:text-xl text-justify">Fort de notre expérience dans l'équitation, nous mettons tout en oeuvre pour vous fournir le meilleur dans vos écuries. Nous sommes une entreprise familiale de construction de bâtiments conçus spécialement pour les activités équestres. 
        ...
        <section className="mt-4 lg:mt-8 relative grid grid-cols-2 grid-rows-2 gap-4">
          {/* Bloc superposé */}
          <div className="absolute z-10 bg-black/25 backdrop-blur-md rounded-xl py-4 px-4 lg:px-6 xl:px-8 shadow-md h-fit w-3/4 sm:w-1/2 lg:w-1/3 xl:w-1/4 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-evenly gap-1.5 sm:gap-3 text-center text-white gap-3xl">
            <h2 className="text-s lg:text-xl font-semibold 2xl:text-2xl">Équipements d'écuries</h2>
            <p className="text-xs lg:text-lg 2xl:text-lg">Gamme d'équipements fabriqués par nos soins. Herses, boxes, barns, cavalettis...</p>
            <button className="text-white p-1.5 lg:p-3 gold-bg rounded-xl w-[80%] mx-auto text-xs lg:text-lg hover:shadow-lg hover:brightness-110 transition-all duration-300" type='button'>
              <Link href="/equipements">Voir nos différents équipements</Link>
            </button>
          </div>
