...
{/* Version Desktop */}
    <nav className='white-bg hidden md:block w-full'>
        <div className='font-medium text-sm'>
            <ul className='flex flex-wrap gap-5 justify-center items-center overflow-visible w-full'>
            ...
            <div className="flex min-w-[120px]">
                ...
                <li className='relative group'>
                    ...
                    <ul className='absolute top-full left-0 mt-2 hidden group-hover:block white-bg shadow-md z-50 text-left text-sm min-w-[200px]'>
                        <li>
                ...
                <li>
                    <Link href="/contact" className={isActive('/contact') ? 'gold-text font-bold' : ''}>
                        Contact
                    </Link>
                </li>
    ...
    <nav className='block md:hidden w-full white-bg z-50'>
        ...
        {isMobileOpen && (
            <ul className='flex flex-col space-y-4 px-4 pb-4 text-sm font-medium shadow'>
                ...
                <li><Link href="/batiments-solaires" className="font-semibold">Bâtiments Solaires</Link>
                ...
                <li className="font-semibold"><Link href="/contact" onClick={() => setIsMobileOpen(false)}>Contact</Link></li>
