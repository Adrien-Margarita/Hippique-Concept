            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <ul className="space-y-2">
                  <li><Link href="/" className="hover:gold-text transition-colors text-xs sm:text-sm">Accueil</Link></li>
                  <li><Link href="/batiments-solaires" className="hover:gold-text transition-colors text-xs sm:text-sm">Bâtiments</Link></li>
                  <li><Link href="/equipements-ecuries" className="hover:gold-text transition-colors text-xs sm:text-sm">Équipements</Link></li>
                  <li><Link href="/constructions" className="hover:gold-text transition-colors text-xs sm:text-sm">Nos constructions</Link></li>
                </ul>
              </div>
              <div>
                <ul className="space-y-2">
                  <li><Link href="/a-propos" className="hover:gold-text transition-colors text-xs sm:text-sm">Qui sommes-nous</Link></li>
                  <li><Link href="/etude-faisabilite" className="hover:gold-text transition-colors text-xs sm:text-sm">Demander une étude</Link></li>
                  <li><Link href="/mentions-legales" className="hover:gold-text transition-colors text-xs sm:text-sm">Mentions légales</Link></li>
                  <li><Link href="/contact" className="hover:gold-text transition-colors text-xs sm:text-sm">Contact</Link></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col">
              <div className="flex max-w-full">
                <input 
                  ...
                  required
                />
                <button type="submit" className="gold-bg text-white p-2 rounded-r-md whitespace-nowrap text-xs sm:text-sm">
                  S'abonner
                </button>
              </div>
              {subscribed && (
