...
export default function HomePage() {
  return (
    ...
    <div className="xl:px-10 sm:px-4 xl:mt-10 mt-4 px-4">
      <div className="relative w-full">
        <img src="/mainHome.webp" alt="paysage avec deux Sulky" className="rounded-xl" />
        
        {/* Bloc supperposé */}
        <div className="absolute sm:top-8 sm:left-8 bottom-0 h-fit bg-black/25 backdrop-blur-md rounded-xl py-2 sm:py-4 px-4 sm:px-8 shadow-md xl:w-1/4 flex flex-col justify-evenly gap-1 sm:gap-3 text-center w-[100%] sm:w-1/2 ">
          <h2 className="text-s md:text-xl font-bold text-white">Au service de vos besoins</h2>
      ...
      <section className="flex flex-col md:flex-row my-4 sm:my-8 sm:gap-4">
        <div className="flex flex-col text-center sm:w-1/2 items-center justify-evenly p-4 sm:p-8">
            <h2 className="sm:text-3xl text-lg font-bold text-center sm:w-[75%] py-5 border-t-2 border-b-2 border-[color:var(--gold)]">
              Une famille de cavaliers qui s'investit pour les cavaliers
            </h2>
            <p className="sm:text-xl text-base sm:w-3/4 py-4">
    ...
    {/* Fond déroulant */}
    <div className="h-[10rem] sm:h-[28rem] w-screen bg-[url('/abri-de-prairie.webp')] sm:bg-[url('/view3.jpg')] bg-cover bg-center sm:bg-center sm:bg-fixed mb-4 sm:mb-8">
    </div>
    ...
    <div className="px-4 sm:px-10">
      ...
      <section className="mt-4 sm:mt-8 relative grid grid-cols-2 grid-rows-2 gap-4">
        {/* Bloc superposé */}
        <div className="absolute z-10 bg-black/25 backdrop-blur-md rounded-xl py-4 px-4 sm:px-8 shadow-md h-fit w-3/4 sm:w-1/4 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-evenly gap-1.5 sm:gap-3 text-center text-white">
          <h2 className="text-s sm:text-xl font-semibold">Équipements d'écuries</h2>
          <p className="text-xs sm:text-base">Gamme d'équipements fabriqués par nos soins. Herses, boxes, barns, cavalettis...</p>
          <button className="text-white p-1.5 sm:p-3 gold-bg rounded-xl w-[80%] mx-auto text-xs sm:text-lg" type='button'>
      ...
      <section className="mt-4 sm:mt-8 sm:flex">
        {/* Partie gauche */}
        <div className="sm:w-1/2 flex flex-col justify-center items-center sm:gap-4">
          <div className="flex flex-col items-center gap-1 border-2 border-[color:var(--gold)] rounded-xl py-6 sm:py-8 px-8 sm:px-12 text-s sm:text-xl w-[80%] sm:w-[70%]">
            <img src="/logo.jpg" alt="logo Hippique Concept" className="w-1/2"/>
            <h2 className="font-bold mb-1.5 sm:mb-3">Contact</h2>
            <p>112 Rue du Docteur Guérin</p>
            <p>83210 La Farlède</p>
            <p>France</p>
            <p className="my-1.5 sm:my-3 font-medium">etude.solaire.concept@gmail.com</p>
            <p>07.72.08.44.06</p>
            <p>04.94.36.00.84</p>
          </div>
        </div>
        ...
        {/* Partie droite */}
        <div className="mt-4 sm:mt-0 sm:w-1/2 gold-bg sm:rounded-tl-xl sm:rounded-bl-xl">
          <Form />
        </div>
      </section>
      </div>
